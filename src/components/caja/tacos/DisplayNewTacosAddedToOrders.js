...
const DisplayNewProductAddedToOrders = () => {
      ...
      <html>
        ...
        <body>
          <div class="order-div">
            ...
            <ul class="no-bullet">
              ${order.alimentos
                .filter((alimento) => alimento.categoria === 'Tacos')
                .map(
                  (alimento) =>
  ...
  return (
    <div className="container">
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {orders
          .filter((order) =>
            order.alimentos.some((alimento) => alimento.categoria === 'Tacos')
          )
          .map((order) => (
            <div
              key={order._id}
            ...
            >
              ...
              >
                Imprimir Tacos Mesa {order.mesa}
              </button>
            </div>
          ))}
      </div>
...
export default DisplayNewProductAddedToOrders;
